                      ...
                      {datafilm.map((movies) => {
                        return (
                          ...
                          <div className="card" key={movies._id}>
                            ...
                            <img src={movies.selectedFile} height="220" className="card-img-top" alt="..." />
                            <div className="card-body">
                              <section className="d-flex justify-content-between">
                                <div>
                                  <Link to={`/film-detay/${movies._id}`} > <i className="bi bi-play-circle-fill card-icon"  ></i></Link>
                                  <Link to="/favoriler" onClick={() => handleFavoriteClick(movies._id)}><i className="bi bi-plus-circle card-icon"></i></Link>
                                </div>
                                <div>
