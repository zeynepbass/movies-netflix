...
export declare const useProps: (props: Partial<RelationGraph>, defaultProps: Partial<RelationGraph>) => {
    ...
    errorTemplate?: string | number | boolean | import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | Iterable<import("react").ReactNode> | ((e: Error) => import("react").ReactNode);
};
