                ...
                var createRowItems_1 = function (item, contentWidth, startX, index) {
                    ...
                    keys.forEach(function (key, keyIndex) {
                        ...
                        var keyShape = group.addShape(isIcon ? 'image' : 'text', {
                            attrs: __assign(__assign({ textBaseline: 'top', x: startX + x, y: height, text: item[key], img: item[key] }, (isIcon ? defaultIconStyle : constants_1.defaultLabelStyle)), (isIcon
                                ? (0, util_1.omit)((0, utils_1.getStyle)(itemStyle || labelStyle, cfg, group, key), ['fill'])
                                : (0, utils_1.getStyle)(itemStyle || labelStyle, cfg, group, key))),
