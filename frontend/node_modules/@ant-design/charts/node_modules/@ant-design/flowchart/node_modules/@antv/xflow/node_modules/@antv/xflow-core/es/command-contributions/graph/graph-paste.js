...
let GraphPasteSelectionCommand = GraphPasteSelectionCommand_1 = class GraphPasteSelectionCommand {
    constructor() {
        ...
        this.getEdgeCopiedConfig = (edgeConfig) => {
            ...
            const { id, source, target } = edgeConfig, otherEdgeConfig = __rest(edgeConfig, ["id", "source", "target"]);
            return Object.assign(Object.assign({}, otherEdgeConfig), { originalId: id, source: nodeMappingRecord.get(((source === null || source === void 0 ? void 0 : source.cell) || source)), target: nodeMappingRecord.get(((target === null || target === void 0 ? void 0 : target.cell) || target)) });
        };
        /** 执行Cmd */
