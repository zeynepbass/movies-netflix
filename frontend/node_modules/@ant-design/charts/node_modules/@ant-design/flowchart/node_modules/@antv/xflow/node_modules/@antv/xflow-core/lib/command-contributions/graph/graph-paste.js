...
var GraphPasteSelectionCommand = /** @class */ (function () {
    ...
    function GraphPasteSelectionCommand() {
        ...
        this.getEdgeCopiedConfig = function (edgeConfig) {
            var nodeMappingRecord = _this.mappingHelper.nodeMappingRecord;
            var id = edgeConfig.id, source = edgeConfig.source, target = edgeConfig.target, otherEdgeConfig = tslib_1.__rest(edgeConfig, ["id", "source", "target"]);
            return tslib_1.__assign(tslib_1.__assign({}, otherEdgeConfig), { originalId: id, source: nodeMappingRecord.get(((source === null || source === void 0 ? void 0 : source.cell) || source)), target: nodeMappingRecord.get(((target === null || target === void 0 ? void 0 : target.cell) || target)) });
        };
        /** 执行Cmd */
                                    ...
                                    switch (_d.label) {
                                        ...
                                        case 2:
                                            ...
                                            return [4 /*yield*/, Promise.all(edges.map(function (edgeConfig) {
                                                    var copiedEdgeConfig = _this.getEdgeCopiedConfig(edgeConfig);
