...
exports.getStarPath = exports.getSpline = exports.getControlPoint = exports.getClosedSpline = void 0;
 ...
 */
var getSpline = exports.getSpline = function getSpline(points) {
  var data = [];
  if (points.length < 2) {
 ...
 */
var getControlPoint = exports.getControlPoint = function getControlPoint(startPoint, endPoint, percent, offset) {
  if (percent === void 0) {
    percent = 0;
  }
  if (offset === void 0) {
 ...
 * @return {Array} Path
 */
var pointsToPolygon = exports.pointsToPolygon = function pointsToPolygon(points, z) {
...
var pathToPoints = exports.pathToPoints = function pathToPoints(path) {
  var points = [];
 ...
 * @param points
 */
var getClosedSpline = exports.getClosedSpline = function getClosedSpline(points) {
  if (points.length < 2) {
 ...
 * @returns
 */
var getStarPath = exports.getStarPath = function getStarPath(outerR, innerR) {
  var path = [];
  for (var i = 0; i < 5; i++) {
