 ...
 */
var dataValidation = exports.dataValidation = function dataValidation(data) {
  // 1. 必须传入数据
  if (!data) {
 ...
 * @return boolean 全部验证通过返回 true，否则返回 false
 */
var singleDataValidation = exports.singleDataValidation = function singleDataValidation(type, data) {
