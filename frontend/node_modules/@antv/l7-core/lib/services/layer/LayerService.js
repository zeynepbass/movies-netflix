...
var LayerService = exports.default = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IRendererService), _dec3 = (0, _inversify.inject)(_types.TYPES.IMapService), _dec4 = (0, _inversify.inject)(_types.TYPES.IDebugService), _dec(_class = (_class2 = /*#__PURE__*/function (_ref) {
  ...
  function LayerService() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "pickedLayerId", -1);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "clock", new _clock.default());
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "layerList", []);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "layerRenderID", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "sceneInited", false);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "animateInstanceCount", 0);
    // TODO: 是否开启 shader 中的颜色拾取计算
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "shaderPicking", true);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "enableRender", true);
    (0, _initializerDefineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderService", _descriptor, (0, _assertThisInitialized2.default)(_this));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "reRender", throttle(function () {
      _this.renderLayers();
    }, 32));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "throttleRenderLayers", throttle(function () {
      _this.renderLayers();
    }, 16));
    return _this;
  }
  (0, _createClass2.default)(LayerService, [{
    ...
    key: "remove",
    value: function () {
      var _remove = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(layer, parentLayer) {
    ...
    key: "removeAllLayers",
    value: function () {
      var _removeAllLayers = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
    ...
    key: "renderLayers",
    value: function () {
      var _renderLayers = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
    ...
    value: function renderMask(masks) {
      ...
      var stencilType = masks.length > 1 ? _ILayerService.StencilType.MULTIPLE : _ILayerService.StencilType.SINGLE;
    ...
    value: function () {
      var _beforeRenderData = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(layer) {
        var flag;
    ...
    value: function renderTileLayerMask(layer) {
      ...
      var stencilType = maskCount > 1 ? _ILayerService.StencilType.MULTIPLE : _ILayerService.StencilType.SINGLE;
    ...
    key: "renderTileLayer",
    value: function () {
      var _renderTileLayer = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee7(layer) {
  ...
  return LayerService;
}(_eventemitter.EventEmitter), (_descriptor = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "renderService", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
