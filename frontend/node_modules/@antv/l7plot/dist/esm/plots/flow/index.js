...
var Flow = /** @class */ (function (_super) {
    ...
    Flow.prototype.createLayers = function (source) {
        this.flowLayer = new ArcLayer(__assign({ name: 'flowLayer', source: source }, pick(this.options, ArcLayer.LayerOptionsKeys)));
        var layerGroup = new LayerGroup([this.flowLayer]);
    ...
    Flow.prototype.createRadiationLayer = function (source) {
        ...
        var radiationLayer = new DotLayer({
            name: 'radiationLayer',
            source: {
                data: data,
    ...
    Flow.prototype.createLabelLayer = function (source, label) {
        ...
        var labelLayer = new TextLayer(__assign({ name: 'labelLayer', source: {
                data: data,
                parser: { type: 'json', coordinates: 'coordinates' },
    ...
    Flow.prototype.updateLayers = function (options) {
        var flowLayerConfig = pick(options, ArcLayer.LayerOptionsKeys);
        this.flowLayer.update(flowLayerConfig);
        if (options.radiation) {
            if (this.radiationLayer) {
                var radiation = __assign(__assign({}, options.radiation), { visible: options.radiation.enabled });
