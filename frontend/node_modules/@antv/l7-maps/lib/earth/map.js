 ...
 * EarthService
 */
var L7EarthService = exports.default = (_dec = (0, _inversify.injectable)(), _dec(_class = /*#__PURE__*/function (_ref) {
  (0, _inherits2.default)(L7EarthService, _ref);
  ...
  function L7EarthService() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "version", 'GLOBEL');
    // TODO: 判断地图是否正在拖拽
      ...
      var _init = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this$config = this.config, _this$config$id = _this$config.id, id = _this$config$id === void 0 ? 'map' : _this$config$id, _this$config$style = _this$config.style, style = _this$config$style === void 0 ? 'light' : _this$config$style, _this$config$rotation = _this$config.rotation, rotation = _this$config$rotation === void 0 ? 0 : _this$config$rotation, rest = (0, _objectWithoutProperties2.default)(_this$config, _excluded);
              this.viewport = new _Viewport.default();
              this.$mapContainer = this.creatMapContainer(id);
              // @ts-ignore
              this.map = new _l7Map.EarthMap((0, _objectSpread2.default)({
...
}(_BaseMapService.default)) || _class);