 ...
 * AMapService
 */
var Service = exports.default = (_dec = (0, _inversify.injectable)(), _dec(_class = /*#__PURE__*/function (_BaseMapService) {
  (0, _inherits2.default)(Service, _BaseMapService);
  ...
  function Service() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "version", _l7Utils.MapType.MAPBOX);
    return _this;
  }
  (0, _createClass2.default)(Service, [{
    ...
    value: function lngLatToMercator(lnglat, altitude) {
      var _window$maplibregl$Me = window.maplibregl.MercatorCoordinate.fromLngLat(lnglat, altitude),
        _window$maplibregl$Me2 = _window$maplibregl$Me.x,
        x = _window$maplibregl$Me2 === void 0 ? 0 : _window$maplibregl$Me2,
        _window$maplibregl$Me3 = _window$maplibregl$Me.y,
        y = _window$maplibregl$Me3 === void 0 ? 0 : _window$maplibregl$Me3,
        _window$maplibregl$Me4 = _window$maplibregl$Me.z,
        z = _window$maplibregl$Me4 === void 0 ? 0 : _window$maplibregl$Me4;
      return {
        x: x,
        y: y,
        z: z
    ...
    value: function getModelMatrix(lnglat, altitude, rotate) {
      ...
      var modelAsMercatorCoordinate = window.maplibregl.MercatorCoordinate.fromLngLat(lnglat, altitude);
      // @ts-ignore
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (mapInstance) {
                ...
                // @ts-ignore
                this.map = new window.maplibregl.Map((0, _objectSpread2.default)({
    ...
    value: function meterToCoord(center, outer) {
      ...
      var centerLnglat = new _maplibreGl.default.LngLat(center[0], center[1]);
      var outerLnglat = new _maplibreGl.default.LngLat(outer[0], outer[1]);
      var meterDis = centerLnglat.distanceTo(outerLnglat);

      // Tip: 三维世界坐标距离

      var centerMercator = _maplibreGl.default.MercatorCoordinate.fromLngLat({
        lng: center[0],
        lat: center[1]
      });
      var outerMercator = _maplibreGl.default.MercatorCoordinate.fromLngLat({
        lng: outer[0],
        lat: outer[1]
      });
