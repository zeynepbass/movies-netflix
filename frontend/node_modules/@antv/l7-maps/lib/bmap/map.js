...
var BMapService = exports.default = /*#__PURE__*/function (_BaseMapService) {
  (0, _inherits2.default)(BMapService, _BaseMapService);
  var _super = _createSuper(BMapService);
  function BMapService() {
    var _this;
    (0, _classCallCheck2.default)(this, BMapService);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "styleConfig", {
      normal: []
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "currentStyle", 'normal');
    // 事件回调代理
  ...
  (0, _createClass2.default)(BMapService, [{
    key: "getMap",
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return _bmapglloader.default.load({
                key: token,
            ...
            case 21:
              mapContainer = _l7Utils.DOM.getContainer(id); // 存储控件等容器，百度地图实例会被卸载掉，所以实例化后需要重新挂载
              // @ts-ignore
              mapChildNodes = (0, _toConsumableArray2.default)(mapContainer.childNodes); // @ts-ignore
    ...
    value: function meterToCoord(center, outer) {
      var metreDistance = this.getMap().getDistance((0, _construct2.default)(BMapGL.Point, (0, _toConsumableArray2.default)(center)), (0, _construct2.default)(BMapGL.Point, (0, _toConsumableArray2.default)(outer)));
    ...
    value: function lngLatToMercator(_ref15, altitude) {
      ...
      var _this$getMap$lnglatTo = this.getMap().lnglatToMercator(lng, lat),
        _this$getMap$lnglatTo2 = (0, _slicedToArray2.default)(_this$getMap$lnglatTo, 2),
