 ...
 * AMapService
 */
var Service = (_dec = injectable(), _dec(_class = /*#__PURE__*/function (_BaseMapService) {
  _inherits(Service, _BaseMapService);
  ...
  function Service() {
    ...
    _defineProperty(_assertThisInitialized(_this), "version", MapType.MAPBOX);
    return _this;
  }
  _createClass(Service, [{
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (mapInstance) {
                ...
                // @ts-ignore
                this.map = new window.maplibregl.Map(_objectSpread({
    ...
    value: function meterToCoord(center, outer) {
      ...
      var centerLnglat = new maplibregl.LngLat(center[0], center[1]);
      var outerLnglat = new maplibregl.LngLat(outer[0], outer[1]);
      var meterDis = centerLnglat.distanceTo(outerLnglat);

      // Tip: 三维世界坐标距离

      var centerMercator = maplibregl.MercatorCoordinate.fromLngLat({
        lng: center[0],
        lat: center[1]
      });
      var outerMercator = maplibregl.MercatorCoordinate.fromLngLat({
        lng: outer[0],
        lat: outer[1]
      });
